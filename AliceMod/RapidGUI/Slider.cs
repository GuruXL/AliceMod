...
namespace RapidGUI
{
    public static partial class RGUI
    {
        ...
        public static float SliderFloat(float v, float min, float max, float defaultValue, int labelWidth, string label = null, string tooltip = null)
        {
            ...
            GUILayout.Label(labelContent, new GUILayoutOption[] { GUILayout.Width(labelWidth) });
